...
const Skills = () => {
  const skills = {
    frontend: [
      ...
      { name: 'CSS & Tailwind', rating: 80, note: 'Advanced', description: 'Responsive design & utility-first CSS.', logo: CssLogo || defaultLogo },
      { name: 'JavaScript (ES6+)', rating: 75, note: 'Intermediate', description: 'Core JS concepts & modern features.', logo: JavaScriptLogo || defaultLogo },
      { name: 'ReactJS', rating: 90, note: 'Advanced', description: 'Dynamic SPAs with React.', logo: ReactLogo || defaultLogo },
      { name: 'Redux', rating: 70, note: 'Intermediate', description: 'Global state management.', logo: ReduxLogo || defaultLogo },
      { name: 'React Native', rating: 60, note: 'Intermediate', description: 'Cross-platform mobile apps.', logo: ReactLogo || defaultLogo },
      { name: 'Figma', rating: 65, note: 'Intermediate', description: 'UI/UX wireframing & prototyping.', logo: Figma || defaultLogo },
    ],
    backend: [
      { name: 'NodeJS', rating: 65, note: 'Intermediate', description: 'RESTful APIs & server logic.', logo: NodeLogo || defaultLogo },
      ...
      { name: 'Firebase', rating: 85, note: 'Semi-Advanced', description: 'Backend services, hosting & auth.', logo: FirebaseLogo || defaultLogo },
      { name: 'SQLite3', rating: 50, note: 'Basic', description: 'Lightweight SQL engine.', logo: Sqlite || defaultLogo },
      { name: 'JSON', rating: 75, note: 'Intermediate', description: 'Data interchange & APIs.', logo: Json || defaultLogo },
    ],
    tools: [
      { name: 'Git', rating: 60, note: 'Intermediate', description: 'Version control workflows.', logo: GitLogo || defaultLogo },
      { name: 'GitHub', rating: 60, note: 'Intermediate', description: 'Code hosting & collaboration.', logo: GitHubLogo || defaultLogo },
      { name: 'Vercel', rating: 60, note: 'Intermediate', description: 'Modern deployment pipeline.', logo: VercelLogo || defaultLogo },
      { name: 'Microsoft Office', rating: 70, note: 'Proficient', description: 'Docs, spreadsheets, presentations.', logo: Office || defaultLogo },
    ],
    languages: [
      { name: 'Delphi', rating: 50, note: 'Basic', description: 'Legacy programming and UI forms.', logo: Delphi || defaultLogo },
      { name: 'Visual Basic', rating: 50, note: 'Basic', description: 'Basic automation and UI apps.', logo: Vb || defaultLogo },
    ],
    other: [
      { name: 'PC Building & Troubleshooting', rating: 80, note: 'Advanced', description: 'Hardware assembly, diagnostics.', logo: Pc || defaultLogo },
      { name: 'Tech Machinery Ops', rating: 70, note: 'Proficient', description: 'POS, printers, laminators, etc.', logo: Tech || defaultLogo },
      { name: 'Networking & Cisco', rating: 60, note: 'Intermediate', description: 'Packet Tracer & LAN setup.', logo: Cisco || defaultLogo },
      { name: 'System Analysis & SDLC', rating: 65, note: 'Intermediate', description: 'Planning & documenting software.', logo: Sdlc || defaultLogo },
    ],
  };
